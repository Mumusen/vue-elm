<template>
  <div class="goods">
    <div class="menu-wrapper" ref="menuWrapper">
      <ul>
        <li v-for="(item, index) in goods" :key="item.index" class="menu-item" :class="{'current': currentIndex === index}" @click="selectMeun(index,$event)">
...
export default {
  ...
  methods: {
    ...
    _initScroll () {
      this.meunScroll = new BScrool(this.$refs.menuWrapper, {
        click: true
      })
      this.foodsScroll = new BScrool(this.$refs.foodsWrapper, {
        click: true,
        probeType: 3
      })
